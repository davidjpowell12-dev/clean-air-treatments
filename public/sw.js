const CACHE_NAME = 'clean-air-v11';
const STATIC_ASSETS = [
  '/',
  '/app',
  '/index.html',
  ...
  '/css/styles.css?v=11',
  '/js/app.js?v=11',
  '/js/utils/api.js?v=11',
  '/js/utils/offline.js?v=11',
  '/js/pages/dashboard.js?v=11',
  '/js/pages/products.js?v=11',
  '/js/pages/inventory.js?v=11',
  '/js/pages/calculator.js?v=11',
  '/js/pages/applications.js?v=11',
  '/js/pages/properties.js?v=11',
  '/js/pages/ipm.js?v=11',
  '/js/pages/scheduling.js?v=11',
