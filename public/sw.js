const CACHE_NAME = 'clean-air-v12';
const STATIC_ASSETS = [
  '/',
  '/app',
  '/index.html',
  ...
  '/css/styles.css?v=12',
  '/js/app.js?v=12',
  '/js/utils/api.js?v=12',
  '/js/utils/offline.js?v=12',
  '/js/pages/dashboard.js?v=12',
  '/js/pages/products.js?v=12',
  '/js/pages/inventory.js?v=12',
  '/js/pages/calculator.js?v=12',
  '/js/pages/applications.js?v=12',
  '/js/pages/properties.js?v=12',
  '/js/pages/ipm.js?v=12',
  '/js/pages/scheduling.js?v=12',
