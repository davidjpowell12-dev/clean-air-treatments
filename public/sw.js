const CACHE_NAME = 'clean-air-v73';
const STATIC_ASSETS = [
  '/',
  '/app',
  '/index.html',
  ...
  '/js/pages/properties.js?v=26',
  '/js/pages/ipm.js?v=24',
  '/js/pages/scheduling.js?v=30',
  '/js/pages/estimates.js?v=36',
  '/js/pages/invoicing.js?v=30',
  '/js/pages/settings.js?v=32',
