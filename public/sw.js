...
const STATIC_ASSETS = [
  ...
  '/js/app.js?v=9',
  '/js/utils/api.js?v=9',
  '/js/utils/offline.js?v=9',
  '/js/pages/dashboard.js?v=9',
  '/js/pages/products.js?v=9',
  '/js/pages/inventory.js?v=9',
  '/js/pages/calculator.js?v=9',
  '/js/pages/applications.js?v=9',
  '/js/pages/properties.js?v=9',
  '/js/pages/ipm.js?v=9',
  '/js/pages/settings.js?v=9',
  '/logo.png',
  '/manifest.json'
];
